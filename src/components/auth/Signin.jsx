...
export default function LoginPage() {
  ...
  //Xử lý đăng nhập với Gmail
  const handleClickLoginWithGmail = () => {
    // Xử lý đăng nhập với Gmail ở đây
    alert('Đăng nhập với Gmail');
    navigate('/home');
  };
  ...
  return (
    // <div className="flex min-h-screen items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-lg shadow-md">
        <div>
          <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Đăng nhập</h2>
        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <button
              onClick={handleClickLoginWithGmail}
              type="button"
